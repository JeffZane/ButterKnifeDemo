...
import com.xhz.test.corelib.R;
import com.xhz.test.corelib.R2;

import butterknife.BindView;
import butterknife.ButterKnife;

public class CoreLibActivity extends Activity {
    ...
    public static void startTestActivity(@NonNull Activity activity) {
        activity.startActivity(new Intent(activity, CoreLibActivity.class));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_core_lib);
